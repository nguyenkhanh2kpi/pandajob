...
import { Heading, HStack, SlideFade, VStack, Image, Text, Button, Wrap, WrapItem, Avatar, FormLabel, Input, Select, Box, SimpleGrid, Link, Spacer, Textarea, Skeleton, Card, CardBody, Icon, Tag, Accordion, AccordionItem, AccordionButton, AccordionPanel, AccordionIcon } from '@chakra-ui/react'
    ...
    return (
      <Box bgColor={'white'} borderRadius={20} boxShadow={'md'} p={10} w={'100%'}>
        <VStack alignItems={'flex-start'} w={'100%'}>
          ...
          <HStack w={'100%'}>
            <FormLabel w={'20%'}>Ghi chú</FormLabel>
            <Textarea name='comment' onChange={handleOnChangeForm} value={form.comment} w={'100%'} placeholder='note' />
          </HStack>
