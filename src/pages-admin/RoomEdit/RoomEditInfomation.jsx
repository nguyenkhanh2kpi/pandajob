...
import { Box, Breadcrumb, BreadcrumbItem, BreadcrumbLink, Skeleton, Stack } from '@chakra-ui/react'
              ...
              <HStack h={'100%'}>
                ...
                <VStack h={'100%'} w={'82%'} p={2}>
                  ...
                  <HStack spacing={5} w={'100%'} p={2} justifyContent={'flex-start'} mt={0}>
                    ...
                    <Button size='sm' colorScheme='blue' variant='outline'>
                      {room.listCandidate && Array.isArray(room.listCandidate) ? room.listCandidate.length : 0} Addtendee
                    </Button>
                    <Wrap ml={20}>
