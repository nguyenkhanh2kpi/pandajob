import { Box, Breadcrumb, BreadcrumbItem, BreadcrumbLink, Button, Card, CardBody, FormControl, FormLabel, Image, Img, Input, Link, Skeleton, Spinner, Text, Textarea, VStack } from '@chakra-ui/react'
...
export const MyCompany = () => {
  ...
  if (company === undefined) {
    ...
    return (
      <>
        <Box h={1000} fontFamily={'Montserrat'} backgroundColor={'#e9f3f5'} overflow='hidden'>
            ...
            <Box w={'100%'}>
              <Card>
                <CardBody>
                  ...
                  <Button mt={5} w={'100%'} onClick={handeUpdateCompany} color={'#ffffff'} backgroundColor='rgb(3, 201, 215)'>
