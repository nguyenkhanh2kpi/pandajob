  ...
  return (
    <>
      ...
      <Container fontFamily={'Roboto'} h={'425px'} pt={'80px'} pb={'60px'} maxW={'100%'}>
        <Flex h={'160px'} px={'148px'} maxW={'100%'}>
          <Flex direction={'row'}>
            <Flex direction={'column'} pr={'17px'} w={'180px'} h={'100%'}>
              ...
              <Text mt={'20px'} textAlign={'start'} color={'#8292b4'} fontSize={'16px'} fontWeight={'400'}>
                Connect with us
              </Text>
              <Flex h={'25px'} w={'80%'} mb={'20px'} mt={'5px'}>
            ...
            <Flex direction={'column'} pl={'30px'} w={'180px'} h={'100%'}>
              <Text
                textAlign={'start'}
                pb={'12px'}
                color={'#445578'}
            ...
            <Flex direction={'column'} ml={'80px'} h={'100%'} w={'362px'} p={'24px'} borderRadius={'8px'} border={'1px'} borderColor={'gray.300'}>
              <Text textAlign={'start'} fontWeight={'700'} lineHeight={'23px'} fontSize={'16px'}>
                Apply on the go
              </Text>
              <Text textAlign={'start'} fontWeight={'400'} lineHeight={'20px'} fontSize={'13px'} color={'#445578'}>
                Get real-time job updates on our App
              </Text>
              <Flex pt={'16px'} direction={'row'} h={'65px'}>
        ...
        <Flex h={'45px'} px={'148px'} maxW={'100%'}>
          <Flex mr={'30px'} w={'480px'} h={'100%'}>
            <Image cursor={'pointer'} maxH={'60%'} src={'https://static.naukimg.com/s/0/0/i/new-homepage/infoedge-logo.svg'} />
            <Box h={'100%'} ml={'32px'}>
              <Text fontWeight={'400'} color={'#8292b4'} textAlign={'start'} fontSize={'13px'}>
          ...
          <Box w={'120px'} h={'100%'} p={'12px'}>
            <Text fontWeight={'500'} color={'gray.500'} textAlign={'start'} fontSize={'13px'}>
              Our businesses
            </Text>
          </Box>
          <Box w={'534px'} h={'100%'} cursor={'pointer'}>
            <Swiper
              slidesPerView={3}
              spaceBetween={0}
              freeMode={true}
